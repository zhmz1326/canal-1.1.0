...
public final class RowsLogBuffer {
    ...
    public final boolean nextOneRow(BitSet columns) {
        ...
        if (hasOneRow) {
            ...
            try {
                ...
                logger.warn("Fail to fillBitmap for buffer" + buffer.toString(), e);
                value = 0;
            }
        }
        return hasOneRow;
     ...
     * Rows_log_event::print_verbose_one_row
     */
    public final Serializable nextValue(final int type, final int meta, String tableName, String columnName) {
        return nextValue(type, meta, false, tableName, columnName);
    }
     ...
     * Rows_log_event::print_verbose_one_row
     */
    public final Serializable nextValue(final int type, final int meta, boolean isBinary, String tableName, String columnName) {
        ...
        if (fNull) {
            ...
            return fetchValue(type, meta, isBinary, tableName, columnName);
        }
    }
     ...
     */
    final Serializable fetchValue(int type, final int meta, boolean isBinary, String tableName, String columnName) {
        int len = 0;
...
//        } catch (Exception e) {
//            logger.warn("Fail to parse data, table: " + tableName + ", column: " + columnName, e);
//        }
